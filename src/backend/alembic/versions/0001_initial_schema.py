...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("nominal_params", postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("contradicting_signals", postgresql.JSONB(astext_type=sa.Text()), nullable=False),
